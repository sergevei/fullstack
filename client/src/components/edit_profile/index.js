...
class CreateProfile extends Component {
    ...
    componentWillReceiveProps(nextProps){
      ...
      if(nextProps.profile.profile){
          const nextProfile = nextProps.profile.profile;
            
          nextProfile.aboutYourself     = !isEmpty(nextProfile.aboutYourself) ? nextProfile.aboutYourself : "";
          nextProfile.handle            = !isEmpty(nextProfile.handle) ? nextProfile.handle : "";
          nextProfile.contactNumber     = !isEmpty(nextProfile.contactNumber) ? nextProfile.contactNumber : "";
          nextProfile.status            = !isEmpty(nextProfile.status) ? nextProfile.status : "";
          nextProfile.contactEmail      = !isEmpty(nextProfile.contactEmail) ? nextProfile.contactEmail : "";

          nextProfile.social.vk         = !isEmpty(nextProfile.social.vk) ? nextProfile.social.vk : "";
          nextProfile.social.facebook   = !isEmpty(nextProfile.social.facebook) ? nextProfile.social.facebook : "";
          nextProfile.social.instagram  = !isEmpty(nextProfile.social.instagram) ? nextProfile.social.instagram : "";
          nextProfile.social.github     = !isEmpty(nextProfile.social.github) ? nextProfile.social.github : "";

          this.setState({
            about:      nextProfile.aboutYourself,
            nickname:   nextProfile.handle,
            number:     nextProfile.contactNumber,
            status:     nextProfile.status,
            email:      nextProfile.contactEmail,
            vk:         nextProfile.social.vk,
            facebook:   nextProfile.social.facebook,
            instagram:  nextProfile.social.instagram,
            github:     nextProfile.social.github ,
            display:    nextProfile.social.display,
            errors:     {}
          });
      }
    }
...
export default connect(mapStateToProps, {createCurrentProfile ,getCurrentProfile})(withRouter(withStyles(styles)(CreateProfile)));